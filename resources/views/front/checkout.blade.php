<x-front-layout title="Checkout">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // احصل على الـ checkbox وحقول الفاتورة والشحن
            document.getElementById('checkbox-3').addEventListener('change', function() {
                var billingFirstName = document.querySelector('input[name="addr[billing][first_name]"]')
                    .value;
                var billingLastName = document.querySelector('input[name="addr[billing][last_name]"]')
                .value;
                var billingEmail = document.querySelector('input[name="addr[billing][email]"]').value;
                var billingPhoneNumber = document.querySelector('input[name="addr[billing][phone_number]"]')
                    .value;
                var billingStreetAddress = document.querySelector(
                    'input[name="addr[billing][street_address]"]').value;
                var billingCity = document.querySelector('input[name="addr[billing][city]"]').value;
                var billingPostalCode = document.querySelector('input[name="addr[billing][postal_code]"]')
                    .value;
                ...
                // حقول الشحن
                var shippingFirstName = document.querySelector('input[name="addr[shipping][first_name]"]');
                var shippingLastName = document.querySelector('input[name="addr[shipping][last_name]"]');
                var shippingEmail = document.querySelector('input[name="addr[shipping][email]"]');
                var shippingPhoneNumber = document.querySelector(
                    'input[name="addr[shipping][phone_number]"]');
                var shippingStreetAddress = document.querySelector(
                    'input[name="addr[shipping][street_address]"]');
                var shippingCity = document.querySelector('input[name="addr[shipping][city]"]');
                var shippingPostalCode = document.querySelector(
                'input[name="addr[shipping][postal_code]"]');
                var shippingState = document.querySelector('input[name="addr[shipping][state]"]');
                var shippingCountry = document.querySelector('select[name="addr[shipping][country]"]');

                if (this.checked) {
                    // نسخ بيانات الفاتورة إلى الشحن
                    shippingFirstName.value = billingFirstName;
                    shippingLastName.value = billingLastName;
                    shippingEmail.value = billingEmail;
                    shippingPhoneNumber.value = billingPhoneNumber;
                    shippingStreetAddress.value = billingStreetAddress;
                    ...
                    // إذا تم إلغاء التحديد، قم بتفريغ حقول الشحن
